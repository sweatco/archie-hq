...
import { resolvePreferenceApproval } from '../../memory/explicit.js';
import { isAllowedTaskId } from '../../memory/paths.js';
...
export function registerMemoryPreferenceHandlers(boltApp: Pick<AppType, 'action'>): void {
