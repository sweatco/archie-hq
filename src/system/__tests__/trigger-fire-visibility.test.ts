...
vi.mock('../../connectors/slack/channel-canvas.js', () => ({ ensureChannelCanvas: vi.fn() }));
vi.mock('../../connectors/slack/channel-pins.js', () => ({ ensureChannelPins: vi.fn() }));
...
function messageThread(visibility: 'public' | 'private') {
  return {
    threadId: '100.0',
    channel: { id: 'GPRIVATE', name: 'leadership' },
    shared: false,
    taskVisibility: visibility,
    messages: [],
    currentMessageTs: '100.0',
