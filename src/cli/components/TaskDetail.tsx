...
export function TaskDetail({ taskId, onBack, liveEvents, onConnect }: TaskDetailProps) {
  ...
  const logLines: { node: React.ReactNode; approval?: { approvalType: 'edit_mode' | 'research_budget' | 'max_mode'; eventIndex: number } }[] = [];
        ...
        case 'approval:requested': {
          ...
          if (resolved) {
            ...
            logLines.push({
              ...
              approval: {
                approvalType: event.data.approvalType as 'edit_mode' | 'research_budget' | 'max_mode',
                eventIndex: idx,
              },
            });
          }
