...
**Edit Mode**: When you have Write and Edit tools available, you can make code changes. You work in an isolated git worktree on a feature branch. Keep all changes local — do NOT commit or push. Make only the requested changes within your assigned repository.
