...
- A clean source build of the real Sweatcoin app additionally needs a prepared image/cache and approved private dependency access. The existing Sweatcoin canary remains a pinned-artifact launch/debug smoke test rather than evidence of that dependency bootstrap.
